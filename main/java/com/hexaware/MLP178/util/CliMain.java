...
private void disgft() {
  ...
  private String placeOrder() throws ParseException {
    Orders order = new Orders();
    System.out.println("Enter Customer ID ");
    order.setCustomerId(option.nextInt());
    System.out.println("Enter Menu Id 1 ");
    order.setMenuId1(option.nextInt());
    String status1;
    int count=0;
    do{
      System.out.println("Order multiple menu : (yes/no): ");
      status1=option.next();
      if(status1.equalsIgnoreCase("YES")){
        System.out.println("Enter Menu Id 2  ");
        order.setMenuId2(option.nextInt());
      }
      if(status1.equalsIgnoreCase("YES")){
        System.out.println("Enter Menu Id 3 ");
        order.setMenuId3(option.nextInt());
        count = count+1;
      }
      else{
        break;
  ...
  private void orderHistory() {
    ...
    if (choice == 1) {
      ...
      if (count == 1) {
        ...
        System.out.println("-----------------------------------------------------------------"
            + "---------------------------------------------------------------------------------");
        System.out.printf("%15s %15s %15s %15s %15s %15s %15s %15s %15s %15s", "ORD_ID", "CUS_ID",
            "VEN_ID", "MEN_ID1", "MEN_ID2", "ORD_STATUS", "ORD_COMMENTS", "BILL_AMT",
            "ORD_DATE", "ORD_QTY");
        System.out.println();
        System.out.println("----------------------------------------------------------------------------------"
            + "----------------------------------------------------------------");
